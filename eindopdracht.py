...
te zien. Elk jaar heeft een eigen staaf om goed het onderscheid te maken. De y-as geeft 
de som van de internetprijzen weer. Het valt hierbij op, dat de staven vanaf 2015 
aanzienlijk groter zijn, dan van de jaren ervoor. Zo is de staaf van 2018 bijna zeven 
keer zo groot als de staaf van 2010. Waar het in 2010 ging om een som van 3.500 dollar, 
gaat het in 2018 om een som van meer dan 24.000 dollar. Waar ligt dit dan aan? Zijn ze 
internetprijzen zo erg gestegen? Dit enorme verschil komt door het aantal metingen. 
In de latere jaren zijn simpelweg meer metingen gedaan. Uit deze histogram kunnen we 
dus geen conclusies trekken. Om een conclusie te kunnen trekken, zouden we de waarden 
moeten delen door het aantal metingen en dit gemiddelde vergelijken met alle jaren.
In het tweede figuur (te selecteren met de dropdown menu) is de boxplot te zien. 
